...
public sealed class CharacterVirtual : CharacterBase
{
    ...
    [UnmanagedCallersOnly]
    private static unsafe byte OnContactValidateCallback(nint context, nint character, uint bodyID2, uint subShapeID2)
    {
        CharacterVirtual listener = DelegateProxies.GetUserData<CharacterVirtual>(context, out _);

        if (listener.OnContactValidate != null)
        {
            return (byte)(listener.OnContactValidate(listener, new BodyID(bodyID2), new SubShapeID(subShapeID2)) ? 1 : 0);
        }
    ...
    [UnmanagedCallersOnly]
    private static unsafe byte OnCharacterContactValidateCallback(nint context, nint character, nint otherCharacter, uint subShapeID2)
    {
        CharacterVirtual listener = DelegateProxies.GetUserData<CharacterVirtual>(context, out _);

        if (listener.OnCharacterContactValidate != null)
        {
            return (byte)(listener.OnCharacterContactValidate(listener, GetObject(otherCharacter)!, new SubShapeID(subShapeID2)) ? 1 : 0);
        }
        ...
        CharacterContactSettings* ioSettings)
    {
        ...
        if (listener.OnContactAdded != null)
        {
            ...
            listener.OnContactAdded(listener, new BodyID(bodyID2), new SubShapeID(subShapeID2), new RVector3(*contactPosition), *contactNormal, ref settings);
            *ioSettings = settings;
        }
    }
        ...
        CharacterContactSettings* ioSettings)
    {
        ...
        {
            CharacterContactSettings settings = *ioSettings;
            listener.OnContactPersisted(listener, new BodyID(bodyID2), new SubShapeID(subShapeID2), new RVector3(*contactPosition), *contactNormal, ref settings);
            *ioSettings = settings;
        }
    }
        ...
        uint bodyID2, uint subShapeID2)
    {
        ...
        listener.OnContactRemoved?.Invoke(listener, new BodyID(bodyID2), new SubShapeID(subShapeID2));
    }
    ...
    private static unsafe void OnCharacterContactRemovedCallback(nint context, nint character,
        uint otherCharacterID,
        uint subShapeID2)
    {
        CharacterVirtual listener = DelegateProxies.GetUserData<CharacterVirtual>(context, out _);

        listener.OnCharacterContactRemoved?.Invoke(listener, new CharacterID(otherCharacterID), new SubShapeID(subShapeID2));
    }
        ...
        Vector3* ioNewCharacterVelocity)
    {
        ...
        if (listener.OnContactSolve != null)
        {
            ...
            listener.OnContactSolve(listener, new BodyID(bodyID2), new SubShapeID(subShapeID2),
                new RVector3(*contactPosition),
                *contactNormal,
                *contactVelocity,
