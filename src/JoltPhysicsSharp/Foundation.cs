...
public static class Foundation
{
    ...
    [UnmanagedCallersOnly]
    private static unsafe byte OnNativeAssertCallback(byte* expressionPtr, byte* messagePtr, byte* filePtr, uint line)
    {
        ...
        {
            return (byte)(s_assertCallback(expression, message, file, line) ? 1 : 0);
        }
