...
{
    /// <summary>
    /// Key codes for use with <see cref="InputManager"/>.
    /// Integer values match <c>Sokol.SApp.sapp_keycode</c> exactly so that casting is free.
    /// Names follow Unity's KeyCode convention for easy migration.
    /// </summary>
    public enum Key
    {
        None            = 0,
