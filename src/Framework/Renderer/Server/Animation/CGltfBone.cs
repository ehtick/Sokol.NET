// CGltfBone.cs — ported as-is from examples/CGltfViewer/Source/CGltfBone.cs (namespace only;
// dropped the unused `using static Sokol.SLog;`). Stores raw keyframe arrays + interpolates inline.
