#!/bin/bash
# Build libsokol_share.so for Android — standalone Share plugin library.
# Output: libs/android/<abi>/{debug,release}/libsokol_share.so
...
# Usage:    ./plugins/Share/scripts/build-android.sh
#
...
echo "========================================="
echo "sokol_share — Android build"
...
for ABI in "${ANDROID_ABIS[@]}"; do
    ...
    echo "  -> plugins/Share/libs/android/$ABI/release/libsokol_share.so"
done

echo ""
echo "========================================="
echo "sokol_share — Android done!"
for ABI in "${ANDROID_ABIS[@]}"; do
    echo "  $ABI: plugins/Share/libs/android/$ABI/release/libsokol_share.so"
done
echo "========================================="
echo ""
echo "Next: rebuild the APK so libsokol_share.so is packaged alongside libsokol.so."
