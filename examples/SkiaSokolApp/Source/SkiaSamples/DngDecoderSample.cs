...
public class DngDecoderSample : SampleBase
{
	...
	protected override void OnDrawSample(SKCanvas canvas, int width, int height)
	{
		...
		{
			var bitmapWidth = width - 20;
			var bitmapHeight = height / 2;
			var x = (width - bitmapWidth) / 2;
			var y = 25;

			canvas.DrawBitmap(bitmap, SKRect.Create(x, y, bitmapWidth, bitmapHeight));
			
			// Move text below the bitmap
			y += bitmapHeight + 48;
