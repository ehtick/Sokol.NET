...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/computeboids-sapp.glsl --output shaders/compiled/ios/computeboids-sapp-shader.cs --slang metal_ios -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    static readonly byte[] cs_source_metal_ios = {
    ...
    */
    ...
    public static unsafe sg_shader_desc compute_shader_desc(sg_backend backend) {
        if (backend == SG_BACKEND_METAL_IOS) {
            ...
            desc.compute_func.source = System.Text.Encoding.UTF8.GetString(cs_source_metal_ios);
