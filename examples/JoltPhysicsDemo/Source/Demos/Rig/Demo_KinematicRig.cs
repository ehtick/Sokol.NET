...
/// <summary>
/// Port of Samples/Tests/Rig/KinematicRigTest.cpp.
/// Loads Human.tof as a kinematic ragdoll driven by a walk animation.
/// A brick wall is set up for the ragdoll to walk through.
/// </summary>
class Demo_KinematicRig : DemoBase
{
    public override string Name     => "Kinematic Rig";
    ...
    public override unsafe void Init(JPH.BodyInterface bi, JPH.PhysicsSystem sys, List<PhysicsBody> bodies, Random random)
    {
        ...
        // Override all parts to kinematic
        ...
        for (uint i = 0; i < partCount; i++)
        {
            ...
            part.mObjectLayer = LayerNonMoving;
        }
